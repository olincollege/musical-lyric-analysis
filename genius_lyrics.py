...
def get_all_lyrics(album_id):
    ...
    for song in all_tracks:
        ...
        # Upon testing, several weird sequences were found within the lyrics 
        # that must be removed to prevent skewing the results. Each is replaced
        # with empty space.
        for word in REMOVE_FROM_LYRICS:
            song_lyrics.replace(word, '')
